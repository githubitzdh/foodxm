  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="4">
          <el-button type="primary" @click="openadd" class="el-icon-circle-plus">添加会员</el-button>
        </el-col>
      </el-row>
      ...
      <!-- 添加会员start -->
      <el-dialog title="添加会员" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
      ...
      <!-- 修改会员start -->
      <el-dialog title="修改会员" :visible.sync="dialogedble" width="30%" :before-close="handleClose">
...
export default {
  ...
  methods: {
    ...
    async findall() {
      let { data: a } = await userlist(this.params);
